...
# 软件包列表
pkglist="wget unzip grep sed tar ca-certificates coreutils-whoami php8 php7-cgi php8-cli php7-fastcgi php8-fpm php7-mod-mysqli php7-mod-pdo php7-mod-pdo-mysql nginx-extras mariadb-server mariadb-server-extra mariadb-client mariadb-client-extra"
